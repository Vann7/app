...
public class AspectDemo {
    ...
    /**
     * 2.指定一个切点， 匹配com.van.app.controller下的所有类的所有方法
     */
    @Pointcut("execution(* com.van.app.controller..*.*(..))")
...
//        System.out.println("我是前置通知");
        ...
        // AOP 代理的名字 打印 代理的是哪一个方法
        System.out.println("AOP 代理的名字 ： "+signature.getDeclaringTypeName() + ", 代理的方法是 ： "+signature.getName());
...
//        System.out.println("请求 ： "+request+" ,  HttpSession : "+session.getId());
...
//        String str=JSON.toJSONString(parameterMaps);
        Gson gson = new Gson();
        String str = gson.toJson(parameterMaps);
     ...
     * @param keys
     */
    @AfterReturning(value="execution(* com.van.app.controller..*.*(..))",returning = "keys")
    public void doAfterReturningAdvice1(JoinPoint joinPoint,Object keys){
//        System.out.println("后置通知执行了！！");
//        System.out.println("第一个后置返回通知的返回值是 ："+keys);
    }

    @AfterReturning(value="execution(* com.van.app.controller..*.*(..))",returning = "keys",argNames="keys")
...
//        System.out.println("后置最终通知执行了！");
     ...
     */
    @Around("execution(* com.van.app.controller..*.testAround*(..))")
